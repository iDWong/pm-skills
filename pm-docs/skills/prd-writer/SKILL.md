...
| **快速** | **跳过**；单文件 `docs/PRD/YYYY-MM-DD-<主题>-PRD.md`，文内用 `## 第一部分 · 概念对齐` 简要概括 | 默认展开 §4 全部 🔴 | 仅 P0 流程项 |
...
| 路径 | 工作区 **`docs/PRD/`**（无则创建） |
| 概念版 | `docs/PRD/YYYY-MM-DD-<主题>-概念版.md` |
| 落地版 | `docs/PRD/YYYY-MM-DD-<主题>-PRD.md`；文首 **一行链回** 概念版路径 |
| 评审报告 | `docs/PRD/YYYY-MM-DD-<主题>-PRD-评审.md`（模式 B 默认落盘） |
...
3. 登记 `PRD_SOURCE=<本 PRD 路径>`；转写完成前 `SPEC_SOURCE` 仍指向 PRD（若已登记）
...
- **依赖**：Python 3；可访问 `../config.json` 中 `apiBaseUrl`
